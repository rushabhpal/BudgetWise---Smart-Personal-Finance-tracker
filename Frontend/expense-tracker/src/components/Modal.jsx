...
const Modal = ({ children, isOpen, onClose, title }) => {
  ...
  return (
    ...
    <div className="fixed top-0 right-0 left-0 z-50 flex justify-center itmes-center w-full h-[calc(100%-1rem)] max-h-full overflow-y-auto overflow-x-hidden bg-black/20 bg-black/20 bg-opacity-50 ">
